...
def test():
  ...
  test_project_score1 = [200,180,150]
  expected_project_score1 = 200 + 180 +150

  if calculate_project_score(test_project_score1) == expected_project_score1:
    print('TEST 3.1 passed')
  else:
    print('TEST 3.1 failed')

  #TEST 4: Test midterm score calculation
  test_midterm_score1 = [90,60]
  expected_midterm_score1 = 90+60

  if calculate_midterm_score(test_midterm_score1) == expected_midterm_score1:
